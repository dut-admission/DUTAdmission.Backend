namespace DUTAdmissionSystem.NewDatabase
{
    ...
    public class DataContext : DbContext
    {
        ...
        // 'DUTAdmissionSystem.NewDatabase.DataContext' database on your LocalDb instance. 
        // 
        // If you wish to target a different database and/or database provider, modify the 'DataContext' 
        // connection string in the application configuration file.
        public DataContext()
            : base(@"data source=103.95.197.121;initial catalog=DUTAdmission.v2;User Id=sa;Password=Server2019@)!(;")
        {
        }
        ...
        public virtual DbSet<HighSchoolPosition> HighSchoolPositions { get; set; }
        public virtual DbSet<HighSchoolYear> HighSchoolYears { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HighSchoolYear>()
                .HasMany(e => e.HighSchoolResults)
                .WithRequired(e => e.HighSchoolYear)
                .HasForeignKey(e => e.HighSchoolYearId)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<PositionType>()
                .HasMany(e => e.HighSchoolPositions)
